<?php
	...
	if($_GET['p'] != ''){
		$plot_img_query	=	"select plot_img, project_name from project where project_id='".$_GET['p']."'";
		$plot_img_result	=	$db_obj->getResult($plot_img_query);
		$plot_img			=	current($plot_img_result)['plot_img'];
		$project_name			=	current($plot_img_result)['project_name'];		
											...
											<div class="row">
												<div class="service-head">
													<div class="drill-txt-lg dtl-center title_bg_content service">
														<h2 style="#222e35"><?php echo $project_name; ?></h2>
													</div>
												</div>
												<div class="clr"></div>
												<div class="">
